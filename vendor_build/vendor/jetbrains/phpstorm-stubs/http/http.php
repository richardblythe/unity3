...
\class_alias('Unity3_Vendor\\HttpException', 'HttpException', \false);
class HttpRuntimeException extends \HttpException
{
}
\class_alias('Unity3_Vendor\\HttpRuntimeException', 'HttpRuntimeException', \false);
class HttpInvalidParamException extends \HttpException
{
}
\class_alias('Unity3_Vendor\\HttpInvalidParamException', 'HttpInvalidParamException', \false);
class HttpHeaderException extends \HttpException
{
}
\class_alias('Unity3_Vendor\\HttpHeaderException', 'HttpHeaderException', \false);
class HttpMalformedHeadersException extends \HttpException
{
}
\class_alias('Unity3_Vendor\\HttpMalformedHeadersException', 'HttpMalformedHeadersException', \false);
class HttpRequestMethodException extends \HttpException
{
}
\class_alias('Unity3_Vendor\\HttpRequestMethodException', 'HttpRequestMethodException', \false);
class HttpMessageTypeException extends \HttpException
{
}
\class_alias('Unity3_Vendor\\HttpMessageTypeException', 'HttpMessageTypeException', \false);
class HttpEncodingException extends \HttpException
{
}
\class_alias('Unity3_Vendor\\HttpEncodingException', 'HttpEncodingException', \false);
class HttpRequestException extends \HttpException
{
}
\class_alias('Unity3_Vendor\\HttpRequestException', 'HttpRequestException', \false);
class HttpRequestPoolException extends \HttpException
{
}
\class_alias('Unity3_Vendor\\HttpRequestPoolException', 'HttpRequestPoolException', \false);
class HttpSocketException extends \HttpException
{
}
\class_alias('Unity3_Vendor\\HttpSocketException', 'HttpSocketException', \false);
class HttpResponseException extends \HttpException
{
}
\class_alias('Unity3_Vendor\\HttpResponseException', 'HttpResponseException', \false);
class HttpUrlException extends \HttpException
{
}
\class_alias('Unity3_Vendor\\HttpUrlException', 'HttpUrlException', \false);
class HttpQueryStringException extends \HttpException
{
}
\class_alias('Unity3_Vendor\\HttpQueryStringException', 'HttpQueryStringException', \false);
/**
 ...
 * @link https://php.net/manual/en/class.httpdeflatestream.php
 */
\class_alias('Unity3_Vendor\\HttpDeflateStream', 'HttpDeflateStream', \false);
/**
 ...
 * @link https://php.net/manual/en/class.httpinflatestream.php
 */
\class_alias('Unity3_Vendor\\HttpInflateStream', 'HttpInflateStream', \false);
/**
 ...
 * @link https://php.net/manual/en/class.httpmessage.php
 */
\class_alias('Unity3_Vendor\\HttpMessage', 'HttpMessage', \false);
/**
 ...
 * @link https://php.net/manual/en/class.httpquerystring.php
 */
\class_alias('Unity3_Vendor\\HttpQueryString', 'HttpQueryString', \false);
/**
 ...
 * @link https://php.net/manual/en/class.httprequest.php
 */
\class_alias('Unity3_Vendor\\HttpRequest', 'HttpRequest', \false);
...
\class_alias('Unity3_Vendor\\HttpRequestDataShare', 'HttpRequestDataShare', \false);
/**
 ...
 * @link https://php.net/manual/en/class.httprequestpool.php
 */
\class_alias('Unity3_Vendor\\HttpRequestPool', 'HttpRequestPool', \false);
/**
 ...
 * @link https://php.net/manual/en/class.httpresponse.php
 */
\class_alias('Unity3_Vendor\\HttpResponse', 'HttpResponse', \false);
class HttpUtil
{
    /**
...
\class_alias('Unity3_Vendor\\HttpUtil', 'HttpUtil', \false);
/**
