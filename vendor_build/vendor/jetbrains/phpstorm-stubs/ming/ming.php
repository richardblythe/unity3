...
// Start of ming v.
\class_alias('Unity3_Vendor\\SWFShape', 'SWFShape', \false);
class SWFFill
{
    public function __construct()
    {
...
\class_alias('Unity3_Vendor\\SWFFill', 'SWFFill', \false);
class SWFGradient
{
    public function __construct()
    {
...
\class_alias('Unity3_Vendor\\SWFGradient', 'SWFGradient', \false);
class SWFBitmap
{
    public function __construct()
    {
...
\class_alias('Unity3_Vendor\\SWFBitmap', 'SWFBitmap', \false);
class SWFText
{
    public function __construct()
    {
...
\class_alias('Unity3_Vendor\\SWFText', 'SWFText', \false);
class SWFTextField
{
    public function __construct()
    {
...
\class_alias('Unity3_Vendor\\SWFTextField', 'SWFTextField', \false);
class SWFFont
{
    public function __construct()
    {
...
\class_alias('Unity3_Vendor\\SWFFont', 'SWFFont', \false);
...
\class_alias('Unity3_Vendor\\SWFDisplayItem', 'SWFDisplayItem', \false);
class SWFMovie
{
    public function __construct()
    {
...
\class_alias('Unity3_Vendor\\SWFMovie', 'SWFMovie', \false);
class SWFButton
{
    public function __construct()
    {
...
\class_alias('Unity3_Vendor\\SWFButton', 'SWFButton', \false);
class SWFAction
{
    public function __construct()
    {
...
\class_alias('Unity3_Vendor\\SWFAction', 'SWFAction', \false);
class SWFMorph
{
    public function __construct()
    {
...
\class_alias('Unity3_Vendor\\SWFMorph', 'SWFMorph', \false);
class SWFSprite
{
    public function __construct()
    {
...
\class_alias('Unity3_Vendor\\SWFSprite', 'SWFSprite', \false);
class SWFSound
{
    public function __construct()
    {
...
\class_alias('Unity3_Vendor\\SWFSound', 'SWFSound', \false);
class SWFFontChar
{
    public function addChars()
    {
...
\class_alias('Unity3_Vendor\\SWFFontChar', 'SWFFontChar', \false);
...
\class_alias('Unity3_Vendor\\SWFSoundInstance', 'SWFSoundInstance', \false);
...
\class_alias('Unity3_Vendor\\SWFVideoStream', 'SWFVideoStream', \false);
/**
 * Set cubic threshold
