...
// Start of svn v.1.0.1
\class_alias('Unity3_Vendor\\Svn', 'Svn', \false);
class SvnWc
{
    const NONE = 1;
    const UNVERSIONED = 2;
...
\class_alias('Unity3_Vendor\\SvnWc', 'SvnWc', \false);
class SvnWcSchedule
{
    const NORMAL = 0;
    const ADD = 1;
...
\class_alias('Unity3_Vendor\\SvnWcSchedule', 'SvnWcSchedule', \false);
class SvnNode
{
    const NONE = 0;
    const FILE = 1;
...
\class_alias('Unity3_Vendor\\SvnNode', 'SvnNode', \false);
/**
 * (PECL svn &gt;= 0.1.0)<br/>
