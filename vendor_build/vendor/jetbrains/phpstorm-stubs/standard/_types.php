 ...
 * @link https://wiki.php.net/rfc/generators
 */
\class_alias('Unity3_Vendor\\Generator', 'Generator', \false);
class ClosedGeneratorException extends \Exception
{
}
\class_alias('Unity3_Vendor\\ClosedGeneratorException', 'ClosedGeneratorException', \false);
namespace Unity3_Vendor\___PHPSTORM_HELPERS;
