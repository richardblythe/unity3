...
namespace Unity3_Vendor\Aws;

use Unity3_Vendor\Aws\Api\Validator;
use Unity3_Vendor\Aws\Api\ApiProvider;
use Unity3_Vendor\Aws\Api\Service;
use Unity3_Vendor\Aws\ClientSideMonitoring\ApiCallAttemptMonitoringMiddleware;
use Unity3_Vendor\Aws\ClientSideMonitoring\ApiCallMonitoringMiddleware;
use Unity3_Vendor\Aws\ClientSideMonitoring\Configuration;
use Unity3_Vendor\Aws\Credentials\Credentials;
use Unity3_Vendor\Aws\Credentials\CredentialsInterface;
use Unity3_Vendor\Aws\Endpoint\PartitionEndpointProvider;
use Unity3_Vendor\Aws\EndpointDiscovery\ConfigurationInterface;
use Unity3_Vendor\Aws\EndpointDiscovery\ConfigurationProvider;
use Unity3_Vendor\Aws\EndpointDiscovery\EndpointDiscoveryMiddleware;
use Unity3_Vendor\Aws\Exception\InvalidRegionException;
use Unity3_Vendor\Aws\Retry\ConfigurationInterface as RetryConfigInterface;
use Unity3_Vendor\Aws\Retry\ConfigurationProvider as RetryConfigProvider;
use Unity3_Vendor\Aws\Signature\SignatureProvider;
use Unity3_Vendor\Aws\Endpoint\EndpointProvider;
use Unity3_Vendor\Aws\Credentials\CredentialProvider;
...
class ClientResolver
{
    ...
    {
        if ($value === \false) {
            $value = new Configuration(\false, \Unity3_Vendor\Aws\ClientSideMonitoring\ConfigurationProvider::DEFAULT_HOST, \Unity3_Vendor\Aws\ClientSideMonitoring\ConfigurationProvider::DEFAULT_PORT, \Unity3_Vendor\Aws\ClientSideMonitoring\ConfigurationProvider::DEFAULT_CLIENT_ID);
            $args['csm'] = $value;
        }
