...
class AwsClient implements AwsClientInterface
{
    ...
    private function parseClass()
    {
        ...
        if ($klass === __CLASS__) {
            return ['', 'Unity3_Vendor\\Aws\\Exception\\AwsException'];
        }
    ...
    private function loadAliases($file = null)
    {
        if (!isset($this->aliases)) {
            ...
            $aliases = \Unity3_Vendor\Aws\load_compiled_json($file);
    ...
    {
        $aliases = \Unity3_Vendor\Aws\load_compiled_json(__DIR__ . '/data/aliases.json');
