...
namespace Unity3_Vendor\Aws\Arn;

use Unity3_Vendor\Aws\Arn\S3\AccessPointArn as S3AccessPointArn;
use Unity3_Vendor\Aws\Arn\ObjectLambdaAccessPointArn;
use Unity3_Vendor\Aws\Arn\S3\OutpostsBucketArn;
use Unity3_Vendor\Aws\Arn\S3\RegionalBucketArn;
