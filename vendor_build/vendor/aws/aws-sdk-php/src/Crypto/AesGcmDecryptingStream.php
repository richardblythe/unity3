...
namespace Unity3_Vendor\Aws\Crypto;

use Unity3_Vendor\Aws\Exception\CryptoException;
use Unity3_Vendor\GuzzleHttp\Psr7;
use Unity3_Vendor\GuzzleHttp\Psr7\StreamDecoratorTrait;
use Unity3_Vendor\Psr\Http\Message\StreamInterface;
use Unity3_Vendor\Aws\Crypto\Polyfill\AesGcm;
use Unity3_Vendor\Aws\Crypto\Polyfill\Key;
/**
