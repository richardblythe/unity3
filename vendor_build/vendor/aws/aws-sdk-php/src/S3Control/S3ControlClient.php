...
namespace Unity3_Vendor\Aws\S3Control;
...
class S3ControlClient extends AwsClient
{
    ...
    public function __construct(array $args)
    {
        ...
        $stack->appendBuild(EndpointArnMiddleware::wrap($this->getApi(), $this->getRegion(), ['use_arn_region' => $this->getConfig('use_arn_region'), 'dual_stack' => $this->getConfig('use_dual_stack_endpoint'), 'endpoint' => isset($args['endpoint']) ? $args['endpoint'] : null]), 's3control.endpoint_arn_middleware');
    }
}
