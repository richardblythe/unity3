...
use Unity3_Vendor\Aws\Arn\S3\AccessPointArn;
...
use Unity3_Vendor\GuzzleHttp\Promise\PromisorInterface;
...
class ObjectCopier implements PromisorInterface
{
    ...
    {
        return \Unity3_Vendor\GuzzleHttp\Promise\coroutine(function () {
