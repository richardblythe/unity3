...
use Unity3_Vendor\Aws\LruArrayCache;
use Unity3_Vendor\Aws\Result;
use Unity3_Vendor\Aws\S3\Exception\S3Exception;
use Unity3_Vendor\GuzzleHttp\Psr7;
use Unity3_Vendor\GuzzleHttp\Psr7\Stream;
use Unity3_Vendor\GuzzleHttp\Psr7\CachingStream;
...
class StreamWrapper
{
    ...
    public function dir_opendir($path, $options)
    {
        ...
        $this->objectIterator = \Unity3_Vendor\Aws\flatmap($this->getClient()->getPaginator('ListObjects', $op), function (Result $result) use($filterFn) {
