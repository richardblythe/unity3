...
use Unity3_Vendor\Aws\S3\S3ClientInterface;
...
class S3EncryptionMultipartUploaderV2 extends MultipartUploader
{
    ...
    private function getEncryptingDataPreparer()
    {
        return function () {
            ...
            list($this->source, $params) = Promise\promise_for($this->encrypt($this->source, $this->config ?: [], $this->provider, $envelope))->then(function ($bodyStream) use($envelope) {
