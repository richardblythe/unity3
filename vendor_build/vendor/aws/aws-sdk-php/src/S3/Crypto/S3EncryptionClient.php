...
use Unity3_Vendor\Aws\Crypto\DecryptionTrait;
use Unity3_Vendor\Aws\HashingStream;
use Unity3_Vendor\Aws\PhpHash;
use Unity3_Vendor\Aws\Crypto\AbstractCryptoClient;
use Unity3_Vendor\Aws\Crypto\EncryptionTrait;
...
class S3EncryptionClient extends AbstractCryptoClient
{
    ...
    public function putObjectAsync(array $args)
    {
        ...
        return Promise\promise_for($this->encrypt(Psr7\Utils::streamFor($args['Body']), $args['@CipherOptions'] ?: [], $provider, $envelope))->then(function ($encryptedBodyStream) use($args) {
