...
namespace Unity3_Vendor\Aws\S3\Crypto;

use Unity3_Vendor\Aws\Crypto\DecryptionTraitV2;
use Unity3_Vendor\Aws\Exception\CryptoException;
use Unity3_Vendor\Aws\HashingStream;
use Unity3_Vendor\Aws\PhpHash;
use Unity3_Vendor\Aws\Crypto\AbstractCryptoClientV2;
use Unity3_Vendor\Aws\Crypto\EncryptionTraitV2;
use Unity3_Vendor\Aws\Crypto\MetadataEnvelope;
use Unity3_Vendor\Aws\Crypto\MaterialsProvider;
use Unity3_Vendor\Aws\Crypto\Cipher\CipherBuilderTrait;
...
class S3EncryptionClientV2 extends AbstractCryptoClientV2
{
    ...
    public function putObjectAsync(array $args)
    {
        ...
        return Promise\promise_for($this->encrypt(Psr7\Utils::streamFor($args['Body']), $args, $provider, $envelope))->then(function ($encryptedBodyStream) use($args) {
