...
namespace Unity3_Vendor\Aws\Multipart;

use Unity3_Vendor\Aws\AwsClientInterface as Client;
use Unity3_Vendor\Aws\CommandInterface;
use Unity3_Vendor\Aws\CommandPool;
use Unity3_Vendor\Aws\Exception\AwsException;
use Unity3_Vendor\Aws\Exception\MultipartUploadException;
use Unity3_Vendor\Aws\Result;
...
abstract class AbstractUploadManager implements Promise\PromisorInterface
{
    ...
    private static $defaultConfig = ['part_size' => null, 'state' => null, 'concurrency' => self::DEFAULT_CONCURRENCY, 'prepare_data_source' => null, 'before_initiate' => null, 'before_upload' => null, 'before_complete' => null, 'exception_class' => 'Unity3_Vendor\\Aws\\Exception\\MultipartUploadException'];
