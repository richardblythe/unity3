...
use Unity3_Vendor\Aws\Exception\InvalidJsonException;
use Unity3_Vendor\Aws\Sdk;
use Unity3_Vendor\GuzzleHttp\Exception\TransferException;
...
class InstanceProfileProvider
{
    ...
    public function __construct(array $config = [])
    {
        ...
        $this->attempts = 0;
        $this->client = isset($config['client']) ? $config['client'] : \Unity3_Vendor\Aws\default_http_handler();
    }
    /**
    ...
    private function request($url, $method = 'GET', $headers = [])
    {
        ...
        $userAgent .= ' ' . \Unity3_Vendor\Aws\default_user_agent();
