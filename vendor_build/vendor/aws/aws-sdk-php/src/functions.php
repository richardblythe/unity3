...
use Unity3_Vendor\GuzzleHttp\Client;
use Unity3_Vendor\Psr\Http\Message\RequestInterface;
use Unity3_Vendor\GuzzleHttp\ClientInterface;
...
function default_http_handler()
{
    ...
    if ($version === 6 || $version === 7) {
        return new \Unity3_Vendor\Aws\Handler\GuzzleV6\GuzzleHandler();
    }
    // If Guzzle 5 installed
    if ($version === 5) {
        return new \Unity3_Vendor\Aws\Handler\GuzzleV5\GuzzleHandler();
    }
...
function default_user_agent()
{
    ...
    // If Guzzle 6 or 7 installed
    if ($version === 6 || $version === 7) {
        return \Unity3_Vendor\GuzzleHttp\default_user_agent();
    }
    // If Guzzle 5 installed
    if ($version === 5) {
        return \Unity3_Vendor\GuzzleHttp\Client::getDefaultUserAgent();
    }
    throw new \RuntimeException('Unknown Guzzle version: ' . $version);
}
/**
...
function guzzle_major_version()
{
    ...
    if (\defined('\\Unity3_Vendor\\GuzzleHttp\\ClientInterface::VERSION')) {
    ...
    } elseif (\defined('\\Unity3_Vendor\\GuzzleHttp\\ClientInterface::MAJOR_VERSION')) {
