...
namespace Unity3_Vendor\Aws\EndpointDiscovery;
...
use Unity3_Vendor\Aws\EndpointDiscovery\Exception\ConfigurationException;
...
class ConfigurationProvider extends AbstractConfigurationProvider implements ConfigurationProviderInterface
{
    ...
    public static function fallback($config = [])
    {
        ...
        return function () use($enabled) {
            return Promise\promise_for(new Configuration($enabled, self::DEFAULT_CACHE_LIMIT));
        };
    }
    /**
