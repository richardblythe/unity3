...
use Unity3_Vendor\GuzzleHttp\Cookie\CookieJar;
use Unity3_Vendor\GuzzleHttp\Exception\GuzzleException;
use Unity3_Vendor\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \Unity3_Vendor\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
