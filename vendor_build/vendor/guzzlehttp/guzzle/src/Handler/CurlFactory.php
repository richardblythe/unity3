...
namespace Unity3_Vendor\GuzzleHttp\Handler;

use Unity3_Vendor\GuzzleHttp\Exception\ConnectException;
use Unity3_Vendor\GuzzleHttp\Exception\RequestException;
use Unity3_Vendor\GuzzleHttp\Promise as P;
use Unity3_Vendor\GuzzleHttp\Promise\FulfilledPromise;
use Unity3_Vendor\GuzzleHttp\Promise\PromiseInterface;
use Unity3_Vendor\GuzzleHttp\Psr7\LazyOpenStream;
use Unity3_Vendor\GuzzleHttp\TransferStats;
use Unity3_Vendor\GuzzleHttp\Utils;
...
class CurlFactory implements CurlFactoryInterface
{
    ...
    private function applyHandlerOptions(EasyHandle $easy, array &$conf) : void
    {
        ...
        if (!isset($options['sink'])) {
            ...
            $options['sink'] = \Unity3_Vendor\GuzzleHttp\Psr7\Utils::tryFopen('php://temp', 'w+');
        }
        $sink = $options['sink'];
        if (!\is_string($sink)) {
            $sink = \Unity3_Vendor\GuzzleHttp\Psr7\Utils::streamFor($sink);
