...
PHP
, 'Static method call statement of a whitelisted class via a use statement' => ['whitelist' => ['Unity3_Vendor\\X\\Foo\\Bar'], 'registered-classes' => [['Unity3_Vendor\\X\\Foo\\Bar', 'Unity3_Vendor\\Humbug\\X\\Foo\\Bar']], 'payload' => <<<'PHP'
<?php
...
PHP
], 'FQ static method call statement of a non-whitelisted class via a use statement' => ['whitelist' => ['Unity3_Vendor\\X\\Foo\\Bar'], 'payload' => <<<'PHP'
<?php
