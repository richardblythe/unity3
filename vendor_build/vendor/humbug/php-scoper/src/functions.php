...
use Unity3_Vendor\Humbug\PhpScoper\Console\Application;
use Unity3_Vendor\Humbug\PhpScoper\Console\ApplicationFactory;
use Iterator;
use Unity3_Vendor\PackageVersions\Versions;
