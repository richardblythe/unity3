...
use Unity3_Vendor\Humbug\PhpScoper\PhpParser\Node\NameFactory;
use Unity3_Vendor\PhpParser\Node;
use Unity3_Vendor\PhpParser\Node\Stmt;
use Unity3_Vendor\PhpParser\Node\Stmt\Declare_;
use Unity3_Vendor\PhpParser\Node\Stmt\GroupUse;
use Unity3_Vendor\PhpParser\Node\Stmt\InlineHTML;
...
use Unity3_Vendor\PhpParser\NodeTraverser as PhpParserNodeTraverser;
