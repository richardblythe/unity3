...
class acf_field_image_select extends acf_field
{
    ...
    function render_field_settings($field)
    {
        ...
        acf_render_field_setting($field, array('label' => __("Choices"), 'type' => 'textarea', 'name' => 'choices', 'instructions' => "Enter your choices one per line. <br /><span style='color:#BC0B0B'>Please note:</span> The first value of each choices will used as name of image.<br>Like for '<strong>Blue</strong>' or '<strong>blue : Blue</strong>', the image name will be '<strong>blue.png</strong>"));
        acf_render_field_setting($field, array('label' => __('Default Value'), 'type' => 'text', 'name' => 'default_value'));
        acf_render_field_setting($field, array('label' => __('Allow Multiple Choices?'), 'name' => 'multiple', 'type' => 'radio', 'choices' => array(1 => __("Yes", 'acf'), 0 => __("No", 'acf')), 'layout' => 'horizontal'));
        acf_render_field_setting($field, array('label' => __('Image Path'), 'instructions' => "Enter complete URL for images<br /><span style='color:#BC0B0B'>Some Important Paths:</span><ul>\n\t\t\t\t\t<li><strong>Theme URL:</strong>" . get_template_directory_uri() . "(<em><u>If current theme is child theme.</u></em>)</li>\n\t\t\t\t\t<li><strong>Current/Child Theme:</strong>" . get_stylesheet_directory_uri() . "</li>\n\t\t\t\t\t<li><strong>Content Folder:</strong>" . content_url() . "</li>\n\t\t\t\t\t<li><strong>Home URL:</strong>" . home_url() . "</li>\n\t\t\t\t</ul>", 'type' => 'text', 'name' => 'image_path'));
        acf_render_field_setting($field, array('label' => \_('Image Extension'), 'type' => 'text', 'name' => 'image_extension'));
    }
    /*
