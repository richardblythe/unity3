...
use Unity3_Vendor\PhpParser\Node\Scalar;
use Unity3_Vendor\PhpParser\Node\Stmt;
use Unity3_Vendor\PhpParser\Node\UnionType;
/**
...
final class BuilderHelpers
{
    ...
    public static function normalizeIdentifier($name) : Identifier
    {
        ...
        throw new \LogicException('Unity3_Vendor\\Expected string or instance of Node\\Identifier');
    }
    /**
    ...
    public static function normalizeIdentifierOrExpr($name)
    {
        ...
        throw new \LogicException('Unity3_Vendor\\Expected string or instance of Node\\Identifier or Node\\Expr');
    }
    /**
    ...
    private static function normalizeNameCommon($name, bool $allowExpr)
    {
        ...
        if ($allowExpr) {
            ...
            throw new \LogicException('Unity3_Vendor\\Name must be a string or an instance of Node\\Name or Node\\Expr');
        }
        throw new \LogicException('Unity3_Vendor\\Name must be a string or an instance of Node\\Name');
    }
    /**
    ...
    public static function normalizeDocComment($docComment) : Comment\Doc
    {
        ...
        throw new \LogicException('Unity3_Vendor\\Doc comment must be a string or an instance of PhpParser\\Comment\\Doc');
    }
    /**
    ...
    public static function normalizeAttribute($attribute) : Node\AttributeGroup
    {
        ...
        if (!$attribute instanceof Node\Attribute) {
            throw new \LogicException('Unity3_Vendor\\Attribute must be an instance of PhpParser\\Node\\Attribute or PhpParser\\Node\\AttributeGroup');
        }
